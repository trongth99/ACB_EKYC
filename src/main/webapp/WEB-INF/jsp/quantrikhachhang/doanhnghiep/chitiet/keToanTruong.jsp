...
<div class="row clearfix">
	<h3 style="clear: both;"><spring:message code="ekycdn.thong_tin_ke_toan_truong" /></h3>
	<hr style="color: #CCC;border-top: 1px solid #CCC;"/>
	
	<c:forEach items="${chiefAccountants}" var="item" varStatus="status">
		<div class="tab">
						<div class="row">
							<div class="col-md-6">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="form-group has-feedback">
					...
					<img src="${contextPath }/fisbank/ekyc-doanh-nghiep/img-byte?path=${item.anhMatTruoc }" style="width: 100%;" />
				</div>
			</div>
			<div class="col-sm-4">
				<div class="form-group has-feedback">
					...
					<img src="${contextPath }/fisbank/ekyc-doanh-nghiep/img-byte?path=${item.anhMatSau }" style="width: 100%;" />
				</div>
			</div>
			<div class="col-sm-4">
				<div class="form-group has-feedback">
					...
					<img src="${contextPath }/fisbank/ekyc-doanh-nghiep/img-byte?path=${item.anhChuKy }" style="width: 100%;" />
				</div>
			</div>
		</div>
		<c:if test="${not empty item.file }">
			<div class="row">
				<div class="col-sm-12">
					<iframe style="width: 100%; height: 300px; border: 0;" src="${contextPath }/fisbank/ekyc-doanh-nghiep/pdf-byte?path=${item.file }"></iframe>
				</div>
			</div>
		</c:if>
