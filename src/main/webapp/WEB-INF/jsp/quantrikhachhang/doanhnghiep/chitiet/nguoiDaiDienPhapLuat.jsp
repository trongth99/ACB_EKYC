...
<div class="row clearfix">
	<h3 style="clear: both;"><spring:message code="ekycdn.nguoi_dai_dien_phap_luat" /></h3>
	<hr style="color: #CCC;border-top: 1px solid #CCC;"/>
	
	<c:forEach items="${legalRepresentators}" var="item" varStatus="status">
		<div class="tab">
						<div class="row">
							<div class="col-md-6">
		...
		<c:if test="${not empty item.file }">
			<div class="row">
				<div class="col-sm-12">
					<iframe style="width: 100%; height: 300px; border: 0;" src="/fisbank/ekyc-doanh-nghiep/pdf-byte?path=${item.file }"></iframe>
				</div>
			</div>
		</c:if>
