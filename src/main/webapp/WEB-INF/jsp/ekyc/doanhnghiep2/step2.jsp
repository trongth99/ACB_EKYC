			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Email Address (*)<br /> <i
						style="font-weight: normal;">Địa chỉ Email (*)</i></label> <input
						...
						<div class="col-sm-4">
							<div class="form-group  has-feedback">
								<label class="control-label">Account Type (*)<br /> <i
									...
									<option
										value="Offshore Loan account / TK vay – trả nợ nước ngoài"
			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Short Name (If applicable)<br />
						<i style="font-weight: normal;">Tên viết tắt (Nếu có)</i></label> <input
						type="text" class="form-control input-sm" id="shortName"
						name="shortName"
			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Fax Number (If utilise)<br />
						<i style="font-weight: normal;">Số fax (Nếu sử dụng)</i></label> <input
						type="text" class="form-control input-sm" id="faxNumber"
						name="faxNumber"
			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Tax Code (If different from
						...
						style="font-weight: normal;">Mã số thuế (Nếu khác với số chứng
							nhận đăng ký doanh nghiệp)</i>
			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Tax Mode <br /> <i
						style="font-weight: normal;">Phương thức khai/nộp thuế</i></label> <select
						...
						<option value="Direct / Trực tiếp khai nộp thuế"
							<c:if test="${ekycDoanhNghiep.taxMode eq 'Direct / Trực tiếp khai nộp thuế' }">selected="selected"</c:if>>Direct
							/ Trực tiếp khai nộp thuế</option>
						<option
							value="Withholding / Khấu trừ tại nguồn bởi đơn vị trả thu nhập"
							<c:if test="${ekycDoanhNghiep.taxMode eq 'Withholding / Khấu trừ tại nguồn bởi đơn vị trả thu nhập' }">selected="selected"</c:if>>Withholding
			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Total Sales Turnover (*)<br />
						<i style="font-weight: normal;">Tổng doanh thu (*)</i></label> <input
						type="text" class="form-control input-sm" id="totalSalesTurnover"
						name="totalSalesTurnover"
			...
			<div class="col-sm-6">
				<div class="form-group  has-feedback">
					<label class="control-label">Total capital (*)<br /> <i
						style="font-weight: normal;">Tổng nguồn vốn (*)</i></label> <input
						type="text" class="form-control input-sm" id="totalCapital"
						name="totalCapital"
				...
				<div class="form-group  has-feedback">
					<label class="control-label"> Agree to receive through all
						means communication<br /> <i style="font-weight: normal;">Đồng
							ý nhận thông tin từ Ngân hàng qua mọi phương tiện liên lạc</i> <input
						type="checkbox" style="margin-left: 20px;" id="agreeToReceive"
						name="agreeToReceive"
						value="<c:out value='${ekycDoanhNghiep.agreeToReceive}'/>" />
					</label>
				</div>
			</div>
		</div>
...
function uploadDuLieuStep3(obj) {
	...
	$.ajax({
		url:'${contextPath}/ekyc-enterprise/luu-thong-tin-step3',
